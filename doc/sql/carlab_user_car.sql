...
CREATE TABLE `user_car` (
  ...
  `car_info` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user_car` VALUES (1,'CC_1','bmw001'),(2,'CC_1',NULL),(3,'CC_1',NULL),(4,'CC_1','update car info'),(5,'CC_0','bmw000'),(6,'CC_0','bmw004'),(7,'CC_0','bmw005');
