...
CREATE TABLE `booking` (
  ...
  `outdoor_charge` int(10) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `booking_no_index` (`booking_no`)
...
INSERT INTO `booking` VALUES (1,1537700231197,'CC_0','velocity',601.50,NULL,100,NULL,'2018-09-23 18:57:11',NULL,NULL,NULL,'2018-09-23 18:57:11','2018-10-03 01:14:19',1);
