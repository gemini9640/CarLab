					...
					<div class="col-xs-12">
						...
						<div class="block_table col-xs-12">
							...
							<div class="table-responsive">
								...
								<div id="sample-table-2_length" class="product_sizeSelector dataTables_length">
								</div>
								</div>
								</div>
								<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
									<thead>
										<tr role="row">
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 162px;"><input class="product_id_main_ck" type="checkbox" /></th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 162px;">ID</th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 162px;">Product Name</th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 194px;">Category</th>
											...
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 194px;">Price</th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 194px;">Duration(hour)</th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 194px;">Date</th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 194px;"></th>
										</tr>
									</thead>
									<tbody class="tabaleData_product" role="alert" aria-live="polite" aria-relevant="all">
									</tbody>
								</table>
								<div class="row product_pageInfo">
								</div>
							</div>
						</div>
						</div>
...
$.LeftMenuConfig.onCatelogProduct();
$.DateTimeConfig.init();
$.TableDataConfig.generateSizeSelector("product", 10);
...
//临时
$.TableDataConfig.pagination("product", 0, 0, 0, 0, 0, 0);
$(".pagination_info").before("<div class='ui-pg-div'><a href='${base}home/catelog/product_add.htm'><span class='ui-icon icon-plus-sign purple'></span></a><span class='ui-icon icon-trash red'></span></div>");
</script>
