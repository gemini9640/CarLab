	...
	function merchantList(pageNumber) {
		...
		$.post("${base}manage/merchant/list.do", {
			...
			if(result.status == 0) {
				...
				$(".pagination_info").before("<div class='ui-pg-div'><a href='${base}home/user/merchant_add.htm'><span class='ui-icon icon-plus-sign purple'></span></a><span class='ui-icon icon-trash red'></span></div>");
			}
		});
	}
	merchantList(1);
