						...
						<div class="block_table col-xs-12">
							...
							<div class="table-responsive">
								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
									<thead>
										<tr role="row">
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 162px;"><input class="staff_id_main_ck" type="checkbox" /></th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 162px;">ID</th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 162px;">Username</th>
...
$.DateTimeConfig.init();
$.TableDataConfig.generateSizeSelector("staff", 10);
...
//临时
$.TableDataConfig.pagination("staff", 0, 0, 0, 0, 0, 0);
$(".pagination_info").before("<div class='ui-pg-div'><a href='${base}home/user/staff_add.htm'><span class='ui-icon icon-plus-sign purple'></span></a><span class='ui-icon icon-trash red'></span></div>");
</script>
