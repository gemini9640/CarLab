					...
					<div class="col-xs-12">
						...
						<div class="block_table col-xs-12">
							<div class="table-header">
								Results for "Sales Staff List"
							</div>
							
							<div class="table-responsive">
								<div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid"><div class="row"><div class="col-sm-6">
								<div id="sample-table-2_length" class="sales_staff_sizeSelector dataTables_length">
								</div>
								</div>
								</div>
								<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
									<thead>
										<tr role="row">
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 162px;"><input class="sales_staff_id_main_ck" type="checkbox" /></th>
											...
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 194px;">Role</th>
									...
									<tbody class="tabaleData_sales_staff" role="alert" aria-live="polite" aria-relevant="all">
									</tbody>
								</table>
								<div class="row sales_staff_pageInfo">
								</div>
							</div>
						</div>
						</div>
...
$.LeftMenuConfig.onUserSalesStaff();
$.DateTimeConfig.init();
$.TableDataConfig.generateSizeSelector("sales_staff", 10); 
...
// 	}
	//临时
$.TableDataConfig.pagination("sales_staff", 0, 0, 0, 0, 0, 0);
$(".pagination_info").before("<div class='ui-pg-div'><a href='${base}home/user/sales_staff_add.htm'><span class='ui-icon icon-plus-sign purple'></span></a><span class='ui-icon icon-trash red'></span></div>");
</script>
