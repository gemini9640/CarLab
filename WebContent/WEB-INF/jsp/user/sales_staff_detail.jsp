										...
										<hr>
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-select-3">Role</label>
													<div class="col-sm-3">
													<select class="width-80 chosen-select" id="form-field-select-3" data-placeholder="Choose a Role">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input class="col-xs-10 col-sm-5" type="text" name="bankaccount" id="bankaccount" />
												</div>
											</div>
